...
housing <- housing[,c(10,1:9)] #move 'median_house_value' column to first
housing_ml <- housing #create separte dataset for maching learning algorithm
housing_ml$ocean_proximity <-c(housing_ml$ocean_proximity) #make 'ocean_proximity'dummy variables for machine learning algorithm
...
summary(model_lin1) #R-squared = 0.6244 -> 0.6361

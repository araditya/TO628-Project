...
housing_train <- housing[4001:20640, ]
housing_test <- housing[1:4000, ]
housing_train_labels <- housing[4001:20640, 1]
housing_test_labels <- housing[1:4001, 1]
library(class)
...
housing_train_labels <- housing[in_train, 1]
housing_test_labels <- housing[-in_train, 1]
housing_test_pred <- knn(train = housing_train, test = housing_test,
                      cl = housing_train_labels, k=21)
